...
export const submitProduct: TSubmitProduct = (type, product) => {
  if(type === "create") {
...
// 因為傳入不確定 CreateProduct、UpdateProduct 所以 .id 會顯示錯誤（UpdateProduct 沒有 id），這時就使用 斷言（因百分百確定）
